    ...
    class BinhLuanController {
        ...
        public function addBinhLuan() {
            ...
            if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                $sanPhamId = isset($_POST['san_pham_id']) ? (int)$_POST['san_pham_id'] : 0; // Ép kiểu về số nguyên
                $noiDung = isset($_POST['noi_dung']) ? $_POST['noi_dung'] : '';
        
                // Lấy thông tin người dùng từ session
                $nguoiBinhLuan = $_SESSION['user']['id']; // Giả định có lưu ID người dùng trong session
                ...
                $result = $this->modelBinhLuan->add($sanPhamId, $noiDung, $nguoiBinhLuan);
        
                if ($result) {
                    // Thêm thành công, quay lại trang chi tiết sản phẩm
            ...
            require_once 'views/chitiet_sanpham.php';
        }
