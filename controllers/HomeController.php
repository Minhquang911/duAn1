    ...
    public function checkLogin(){
        if ($_SERVER['REQUEST_METHOD'] == 'POST'){
            ...
            if ($nguoiDungs == $email){
                ...
                header("Location: http://localhost/base_du_an_1/index.php");
                exit();
            }else{
                ...
                header("Location: http://localhost/base_du_an_1/index.php" . '?act=login');
                exit();
            }
        }  
    }
    ...
    public function checkDangKy(){
        if ($_SERVER['REQUEST_METHOD'] == 'POST'){
            ...
            if ($mat_khau !== $confirm_mat_khau) {
                ...
                header("Location: http://localhost/base_du_an_1/index.php" . '?act=dangky');
                exit();
            }
