    ...
    <div class="page-content">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-xxl-9">
                    <h2 class="text-center" style="color: brown;">Chi tiết Trang Tin Tức</h2>
                    <?php
                    // detail_tintuc.php

                    if ($tinTuc) { // Nếu bài viết tồn tại
                    ?>
                        <div class="container text-center mt-5">
                            <h1><?= htmlspecialchars($tinTuc['tieude']) ?></h1>
                            <p><strong>Ngày tạo:</strong> <?= htmlspecialchars($tinTuc['ngay_tao']) ?></p>
                            <div>
                                <h3>Nội dung:</h3>
                                <p><?= nl2br(htmlspecialchars($tinTuc['noidung'])) ?></p>
                            </div>
                        </div>
                    <?php
                    } else {
