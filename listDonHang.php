                                                        ...
                                                        <?php if (!empty($listdonHang)) : ?>
                                                            <?php foreach ($listdonHang as $key => $donHang) : ?>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <div>
                                                                            <a href="<?= 'http://localhost/base_du_an_all/base_du_an_all/admin/index.php' . '?act=chi-tiet-don-hang&id_don_hang=' . $donHang['id'] ?>">
                                                                                <button class="btn btn-primary"><i class="far fa-eye"></i>Xem</button>
                                                                            </a>
                                                                            <a href="<?= 'http://localhost/base_du_an_all/base_du_an_all/admin/index.php' . '?act=form-sua-don-hang&don_hang_id=' . $donHang['id'] ?>">
