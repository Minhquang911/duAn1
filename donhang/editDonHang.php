...
<head>
    ...
    <meta charset="utf-8" />
    <title>Cập nhật đơn hàng| NN Shop</title>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
                                <h4 class="mb-sm-0">Quản lý thông tin đơn hàng</h4>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="live-preview">
                                            <form action="<?= 'http://localhost/base_du_an_1/base_du_an_1/admin/index.php' . '?act=sua-don-hang' ?>" method="POST">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" class="form-control" placeholder="Nhập tên người nhận" name="sdt_nguoi_nhan" value="<?= $donHang['sdt_nguoi_nhan'] ?>">
                                                                <span class='text-danger'>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="email" class="form-control" placeholder="Nhập tên người nhận" name="email_nguoi_nhan" value="<?= $donHang['email_nguoi_nhan'] ?>">
                                                                    <span class='text-danger'>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <input type="text" class="form-control" placeholder="Nhập tên người nhận" name="dia_chi_nguoi_nhan" value="<?= $donHang['dia_chi_nguoi_nhan'] ?>">
                                                                        <span class='text-danger'>
                                                                ...
                                                                <div class="form-group">
                                                                    <label>Ghi chú</label>
                                                                    <textarea name="ghi_chu" id="form-control" placeholder="Nhập ghi chú"><?= $donHang['ghi_chu'] ?></textarea>
                                                                </div>
