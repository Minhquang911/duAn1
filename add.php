                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" placeholder=" xin moi nhap tieu de" name="tieude_banner">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" name="hinhanh_banner">
                                                            <span class="text-danger">
                                                                <?= !empty($_SESSION['errors']['trangthai']) ? $_SESSION['errors']['trangthai'] : '' ?>
                                                            </span>
                                                        </div>
